<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDatabase.aspx.cs" Inherits="WebApplication_stored_procedure.WebForm4" %>
    ...
    <asp:Button Text="LOGOUT" ID="btnlogout" runat="server" CssClass="btn btn-info btn-custom mx-2" OnClick="btnlogout_Click" />
        ...
        <div class="container-fluid ms-auto">
            ...
            <div class="mt-4 text-center">
                <asp:Button ID="EditButton" runat="server" Text="Edit" CssClass="btn btn-success btn-custom" OnClick="EditButton_Click" />
